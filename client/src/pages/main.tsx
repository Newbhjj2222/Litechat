  ...
  return (
    <div className="hidden md:flex flex-col flex-1 items-center justify-center bg-netgray-100">
      <div className="text-center p-8">
        <div className="h-32 w-32 rounded-full bg-primary flex items-center justify-center mx-auto mb-6">
        ...
        <h1 className="text-3xl font-bold text-primary-dark mb-4">Welcome to NetChat</h1>
        <p className="text-netgray-500 mb-6">Connect with friends, create groups, and share your status updates.</p>
        <p className="text-netgray-500">Select a chat to start messaging</p>
      </div>
    </div>
  );
};
